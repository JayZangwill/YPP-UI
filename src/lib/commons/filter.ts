import filterChain from "./chain";
import yppFetch from './../utils/_temp_fetch'
...
var originalFetch = yppFetch.fetch;
window.fetch = function (request: string, options?: any, other = {}): Promise<Response> {
  ...
  return new Promise((resolve, reject) => {
    ...
    var innerXHR = originalFetch(request, options, other);
